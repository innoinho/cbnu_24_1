...
# 창의 크기 조정
root.geometry("500x500")  # 가로 600픽셀, 세로 400픽셀
...
# 입고 수량 입력을 위한 Entry
label_in_stock = tk.Label(frame, text="입고 수량:", bg="lightgrey")
label_in_stock.pack()
entry_in_stock = tk.Entry(frame)
entry_in_stock.pack()

# 출고 수량 입력을 위한 Entry
label_out_stock = tk.Label(frame, text="출고 수량:", bg="lightgrey")
...
label = tk.Label(frame, text="", bg="lightgrey")
label.pack(pady=10)
...
label_less_stock_threshold = tk.Label(frame, text="특정 재고 수량 미만인 품목을 확인하려면 숫자를 입력하세요:", bg="lightgrey")
...
label_new_item = tk.Label(frame, text="새 품목 추가:", bg="lightgrey")
label_new_item.pack()
